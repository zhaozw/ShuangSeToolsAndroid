...
public class DantuoCombineResultActivity extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if(bundle != null) {
      ...
      redDanStr.setText("红胆码：" + MagicTool.getDispArrangedStr(this.selectRedDan));
      redTuoStr.setText("红拖码：" + MagicTool.getDispArrangedStr(this.selectRedTuo));
      blueStr.setText("蓝球：" + MagicTool.getDispArrangedStr(this.selectBlue));
